...
<%
String path=request.getRealPath("/product_image/"); // / means root folder and uploads
%>  
...
if(request.getParameter("did")!=null){
	...
	msg="Cart Item is deleted successfully";
}
...
<table id="tb" class="table table-bordered">
	...
	<tbody>
	<%
	ResultSet rs=db.getRows("select * from Cart where userName=?",session.getAttribute("user"));
	int i=0;
	double amt=0;
	while(rs.next()){
	%>
	<tr>
		...
		<td>
		<img src="<%=rs.getString(7) %>" width="60" height="60" alt="NA" class="rounded"/>
		</td>		
