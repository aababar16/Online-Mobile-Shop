    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-size-20">Online Mobile Shop</h4>
                <p class="font-size-14  text-white-50">The mobile shop company website, created using JSP and MySQL
                    database and bootstrap 5.</p>
            </div>
...
<div class="copyright text-center py-2">
    <p class="font-size-14 my-0">&copy; Copyrights <%=LocalDate.now().getYear() %> Online Mobile Shop</p>
</div>
<!-- !start #footer -->
...
if(!msg.equals("")){
%>
swal("Online Mobile Shop","<%=msg%>","success");
<%
}
%>
function confirm_delete(id){
      swal({
        ...
        text:"Do you want to delete current record of "+id+"?",
        icon:"warning",
        buttons:true,
        dangerMode:true
      }).then((willdelete)=>{
        if(willdelete){
          window.location="?did="+id;
        }else{
